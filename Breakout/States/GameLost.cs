...
public class GameLost : IGameState {
    ...
    private Text gameLost = new Text("Game Lost!", new Vector2(0.05f, 0.8f), 1.5f);
    ...
    public GameLost(StateMachine stateMachine) {
        this.stateMachine = stateMachine;
        newGameText.SetColor(255, 0, 0, 255);
        gameLost.SetColor(255, 0, 0, 255);
    }
    public void Update() {
